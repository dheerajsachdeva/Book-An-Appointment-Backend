class Api::ReservationsController < ApplicationController
  ...
  def create
    ...
    if @reservation.save
      ...
      render json: { status: "Not Found", data: @reservation.errors },
             status: :unprocessable_entity
    end
  end
  ...
  def update
    ...
    if @reservation.empty?
      ...
      render json: { status: "Success", message: "Loaded Reservation", data: @reservation }, status: :ok     end
  end
  ...
  def destroy
    ...
    if @reservation.empty?
      ...
      render json: { status: "Success", message: "Deleted Reservation" }, status: :ok     end
  end
